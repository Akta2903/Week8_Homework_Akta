...
public class Point {
    ...
    public Point(int x, int y) {  //constructor with two parameter
        this.x = x;
        this.y = y;
    }
    ...
    public double distance() { //instance method
        return distance(0, 0);
    }


    public double distance(int x, int y) {  //instance method with two parameter
